        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center animate-fade-in-up">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Accessible and affordable marketing packages catering to sole proprietorships, SMEs, and enterprises alike
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="marketing-card text-center animate-fade-in-up">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Every business is unique. If our standard packages don't perfectly fit your needs, 
              we're happy to create a custom solution tailored specifically for your business goals and budget.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="marketing-card animate-scale-in">
              ...
              <p className="text-muted-foreground">
                All packages include complete account setup, initial strategy consultation, 
                and onboarding to ensure you're ready to see results from day one.
              </p>
            </div>
            ...
            <div className="marketing-card animate-scale-in">
              ...
              <p className="text-muted-foreground">
                Absolutely! You can change your package at any time to better suit your 
            ...
            <div className="marketing-card animate-scale-in">
              ...
              <p className="text-muted-foreground">
                We manage Facebook, Instagram, LinkedIn, Twitter/X, and can expand to other 
            ...
            <div className="marketing-card animate-scale-in">
              ...
              <p className="text-muted-foreground">
                We provide detailed monthly reports covering engagement, reach, growth, 
                and ROI metrics tailored to your business objectives.
              </p>
            </div>
          </div>
        </div>
